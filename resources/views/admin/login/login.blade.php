            ...
            <form class="layui-form" action="" method="post">
                ...
                <div class="layui-form-item">
                 ...
                 <div class="layui-form-item">
                    ...
                    <input type="text" name="captcha"  placeholder="图形验证码" autocomplete="off" class="layui-input verification captcha" >
                    <div class="captcha-img">
                        <img id="captchaPic" src="/admin/captcha" onclick="this.src='/admin/captcha?i='+Math.random()">
                    </div>
                </div>
                <!--
                <div class="layui-form-item">
...
@include("admin.error.error_form")
</body>
</html>